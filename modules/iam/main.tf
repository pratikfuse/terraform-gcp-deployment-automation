...
# Grant Cloud Function SA access to write logs
...
# Grant Cloud Run SA access to read storage (if serving static content)
...
# Grant Cloud Run SA access to write logs
